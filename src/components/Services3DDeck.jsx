...
const servicesData = [
  ...
  {
    id: "service-smm",
    tag: "High-Impact Video Production",
    title: "Reels Shoot & Edit",
    category: "Reels Production & Editing",
    desc: "End-to-end short-form video production. We shoot and edit high-converting Reels tailored for maximum watch time, retention, and brand impact.",
    highlights: [
      "High-Definition Video Shooting",
      "Professional Video Editing & Cuts",
