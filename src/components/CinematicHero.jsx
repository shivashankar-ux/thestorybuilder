...
export default function CinematicHero() {
  useEffect(() => {
    // Slower, butter-smooth Lenis configuration
    const lenis = new Lenis({
      duration: 1.8, // Increased duration for a slower, silkier feel
      easing: (t) => Math.min(1, 1.001 - Math.pow(2, -10 * t)),
      direction: "vertical",
      gestureDirection: "vertical",
      smooth: true,
      mouseMultiplier: 0.8, // Slower mouse wheel
      smoothTouch: false,
      touchMultiplier: 1.5,
      infinite: false,
    });
  ...
  return (
    // Increased scroll depth to 400vh so the animation stretches over a longer scroll
    <section className="relative w-full h-[400vh] bg-[#050505]">
